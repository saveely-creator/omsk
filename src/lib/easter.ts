...
export function labAnalysis(person: Person, seed = 0): LabReport {
	...
	rows.push({
		...
		value: person.stats.avgLen.toFixed(1) + " \u0437\u043d/\u0441\u043e\u043e\u0431\u0449.",
	})
	rows.push({
		label: "\u043d\u043e\u0447\u043d\u0430\u044f \u0444\u0440\u0430\u043a\u0446\u0438\u044f",
...
export function runCommand(input: string, ctx: TerminalCtx): string[] {
	...
	switch (cmd) {
		...
		case "/who": {
			...
			if (!p) return ["\u043d\u0435\u0442 \u0442\u0430\u043a\u043e\u0433\u043e \u043e\u0431\u0440\u0430\u0437\u0446\u0430: " + arg]
			return [
				p.hero + "  \u00b7  " + p.title,
				p.tagline,
				"\u0441\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0439: " +
				...
				"\u043f\u0438\u043a: " +
					p.dossier.peakHours.map((h) => String(h).padStart(2, "0") + ":00").join(", "),
			]
		}

		case "/quote": {
			const p = arg ? getPerson(arg) : PEOPLE[Math.floor(Math.random() * PEOPLE.length)]
			if (!p) return ["\u043d\u0435\u0442 \u0442\u0430\u043a\u043e\u0433\u043e \u043e\u0431\u0440\u0430\u0437\u0446\u0430: " + arg]
		...
		case "/random": {
			...
			const q = p.quotes[Math.floor(Math.random() * p.quotes.length)]
			return ["\u00ab" + q + "\u00bb", "   \u2014 " + p.hero + " (" + p.dossier.spec + ")"]
		}

		case "/goto": {
			const p = getPerson(arg)
			if (!p) return ["\u0444\u043e\u0440\u043c\u0430\u0442: /goto " + PEOPLE[0].slug]
			ctx.go("/p/" + p.slug)
			ctx.close()
		...
		case "/stats":
			return [
				"\u0441\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0439: " + CHAT.totals.messages,
				"\u0440\u0435\u0430\u043a\u0446\u0438\u0439:   " + CHAT.totals.reactions,
				"\u043c\u0435\u043c\u043e\u0432:      " + CHAT.totals.memes,
				"\u043d\u043e\u0447\u043d\u044b\u0445:    " + CHAT.totals.night,
				"\u0434\u043d\u0435\u0439:       " + CHAT.totals.days,
				"\u0431\u0435\u0437 \u043e\u0444\u0444\u0442\u043e\u043f\u0430: " + daysWithoutOfftop(),
			]

		case "/acid":
			ctx.acid()
			return ["\u0430\u0446\u0438\u0434-\u0440\u0435\u0436\u0438\u043c \u043f\u0435\u0440\u0435\u043a\u043b\u044e\u0447\u0451\u043d"]

		case "/vhs":
			ctx.vhs()
			return ["VHS-\u0434\u0438\u0437\u0435\u0440\u0438\u043d\u0433 \u043f\u0435\u0440\u0435\u043a\u043b\u044e\u0447\u0451\u043d"]

		case "/wake":
			ctx.wake()
			return ["\u0431\u0443\u0434\u0438\u043c \u0432\u0441\u0435\u0445. \u0438\u0437\u0432\u0438\u043d\u0438\u0442\u0435."]

		case "/lab":
			ctx.unlockLab()
			ctx.go("/lab")
			ctx.close()
			return ["\u0434\u043e\u0441\u0442\u0443\u043f \u0432 \u0441\u043b\u0443\u0436\u0435\u0431\u043d\u043e\u0435 \u043f\u043e\u043c\u0435\u0449\u0435\u043d\u0438\u0435 \u043e\u0442\u043a\u0440\u044b\u0442"]
...
export function visitedProgress(visited: string[]): { done: number; total: number } {
	const set = new Set(visited)
